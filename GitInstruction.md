...
Это система записывающая изменения в файлах. Позволяет вернуть файлы к состоянию, в которых они были изменены, вернуть проект к исходному состоянию, увидеть все изменения, которые были сделаны.
